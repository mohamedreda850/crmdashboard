import { ListChecks, MoveRight, PencilLine, SquareKanban } from "lucide-react";
...
const Customers = ({customers ,activity}) => {
  return (
    <div className="bg-[#EEF6FB] p-8">
    
      <div className="flex justify-between items-center">
        <h1 className="font-bold text-[18px] ">Customers</h1>
        <Link className="text-[#514EF3] text-sm font-medium">View All</Link>
      </div>
      {customers? <><div>
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center mt-5">
            ...
            <div className="ms-3">
              <h2 className="text-[#092C4C] font-bold">Deanna Annis</h2>
              <p className="text-[#7E92A2] text-sm font-light">
                deannannis@gmail.com
              </p>
            </div>
          </div>
          <PencilLine className="text-[#7E92A2] me-5" />
        </div>
        <div className="flex justify-between items-center">
          <div className="flex items-center mt-5">
            <div className="w-12 h-12 bg-[#D6E1E6] rounded-full" />
